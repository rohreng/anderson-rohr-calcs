...
export type CalcMeta = {
  ...
  // ── visual redesign fields (2026-06-14) ─────────────────────────────────
  material: "Steel" | "Concrete" | "Masonry" | "Wood" | "Cold-Formed Steel" | "Loads";
  calcType:
    | "Lateral Loads"
    ...
    | "Anchors & Development"
    | "Foundations & Piers";
  icon: string; // archetype key — matches a case in CalcIcon.tsx
};
...
export const CALCS: CalcMeta[] = [
  ...
  {
    slug: "hss-column-bearing-on-beam",
    label: "HSS Column Bearing on W-Beam",
    subtitle: "Base plate on beam top flange — web J10.2–J10.5, top-flange bending, bearing stiffeners · composite/non-composite",
    htmlFile: "/Calcs/hss_column_bearing_on_beam_calculator.html",
    category: "Connections",
    spec: "AISC 360-22",
    status: "ready",
    keywords: ["HSS", "column", "base plate", "bearing", "web local yielding", "web local crippling", "web sidesway buckling", "J10", "stiffener", "composite beam", "blockout", "column-on-beam node", "DG24", "DG9"],
    material: "Steel",
    calcType: "Connections",
    icon: "base-plate",
  },
  ...
  {
    slug: "brace-connection-column-on-beam",
    label: "Brace Connection at Column-on-Beam Node",
    subtitle: "Slotted-HSS brace at HSS-column-on-W-beam node — chevron effect, Whitmore, combined J10, dual-purpose gusset",
    htmlFile: "/Calcs/brace_connection_at_column_on_beam_calculator.html",
    category: "Connections",
    spec: "AISC 360-22",
    status: "ready",
    keywords: ["brace", "chevron effect", "Fortney Thornton", "gusset", "Whitmore", "UFM", "DG29", "shear lag", "slotted HSS", "block shear", "J10", "web crippling", "column-on-beam node", "collector", "transfer force", "through-plate", "AISC 360"],
    material: "Steel",
    calcType: "Connections",
    icon: "gusset-brace",
  },
  {
    slug: "composite-stud-blockout",
    label: "Composite Stud / Slab Blockout",
    subtitle: "Stud supply per shear-span segment after a slab blockout — Qn, re-bunching, concentrated-load N₂ provision",
    htmlFile: "/Calcs/composite_stud_blockout_calculator.html",
    category: "Connections",
    spec: "AISC 360-22",
    status: "ready",
    keywords: ["composite beam", "shear studs", "slab blockout", "headed stud", "N2", "concentrated load", "stud spacing", "effective width", "deck", "column-on-beam node"],
    material: "Steel",
    calcType: "Connections",
    icon: "beam-udl",
  },
  ...
  {
    slug: "flange-plated-hss-moment",
    label: "Flange-Plated Moment Connection to HSS Column",
    subtitle: "Welded top/bottom flange plates on a rectangular HSS column face — Ex. II.B-2 plate & weld checks, DG24 Table 7-2 column limit states",
    htmlFile: "/Calcs/flange_plated_HSS_column_moment_connection_calculator.html",
    category: "Connections",
    spec: "AISC 360-22 / DG24",
    status: "ready",
    group: "HSS Connections",
    keywords: ["flange plate", "flange-plated", "HSS column", "moment connection", "FR", "transverse plate", "sidewall", "punching", "local yielding", "Be", "K1-1", "K5-4", "Qf", "DG24", "Table 7-2", "Example II.B-2", "Example 4.3", "J2.4", "J4"],
    material: "Steel",
    calcType: "Connections",
    icon: "hss-joint",
  },
  ...
  {
    slug: "masonry-opening-channel-lintel",
    label: "Steel Channel Lintel — New Opening in Masonry",
    subtitle: "Matched channel pair thru-bolted each face · non-composite default · rod flexure · TMS bolt limit states",
    htmlFile: "/Calcs/masonry_opening_channel_lintel_calculator.html",
    category: "Masonry",
    spec: "AISC 360-22 LRFD / TMS 402-22 Ch.9",
    status: "wip",
    group: "CMU Openings",
    keywords: ["channel", "lintel", "MC", "C shape", "new opening", "cut opening", "existing wall",
      "thru-bolt", "through bolt", "thru rod", "masonry", "CMU", "retrofit", "bond beam",
      "rod bending", "grout bearing", "composite", "shear flow", "TMS 402", "AISC 360",
      "out-of-plane wind", "jamb", "LRFD", "strength design"],
    material: "Masonry",
    calcType: "Beams & Flexure",
    icon: "lintel-opening",
  },
  ...
  {
    slug: "embed-plate-beam-bearing",
    label: "Embed Plate — Beam Bearing at CMU Face",
    subtitle: "Face-mounted plate, (4) anchors 2×2 ASD — anchor tension/shear/interaction, masonry bearing & plate bending, two load cases",
    htmlFile: "/Calcs/embed_plate_beam_bearing_calculator.html",
    category: "Masonry",
    spec: "TMS 402-22 §8.1.4.3 / AISC 360-22 §F11",
    status: "ready",
    group: "CMU Connections",
    keywords: ["masonry", "CMU", "embed plate", "embed", "beam bearing", "wall face", "anchor", "headed anchor", "HAS", "tension", "shear", "interaction", "ASD", "TMS 402", "bearing", "plate bending", "eccentricity", "couple", "wind reversal", "breakout overlap", "IBC 1605.2"],
    material: "Masonry",
    calcType: "Anchors & Development",
    icon: "anchor-masonry",
  },
  ...
  },
  {
    ...
    subtitle: "Wall spanning piers as ACI 318-19 Ch. 23 deep beam — single span, cantilever, or continuous over piers; funicular arch-and-tie, negative-moment chord, nodes, anchorage",
    htmlFile: "/Calcs/deep_beam_stm_calculator.html",
    category: "Concrete",
    spec: "ACI 318-19 Ch. 23 & §9.9",
    status: "ready",
    keywords: ["deep beam", "strut and tie", "STM", "grade beam", "pier", "wall", "tie", "node", "CCT", "anchorage", "funicular", "arch", "ACI 318", "continuous", "multi-span", "continuous spans", "negative moment", "top steel", "moment envelope", "pattern loading", "inflection point", "effective tie width"],
    material: "Concrete",
    calcType: "Walls",
    icon: "retaining-wall",
  },
